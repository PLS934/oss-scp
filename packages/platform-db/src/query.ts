...
export interface ListRecordsInput { pluginId: string; sourceId: string; dataType: string; limit?: number; cursor?: string }
export interface RecordCursorBoundary { lastSeenAt: string; id: string }
export interface NormalizedListRecordsInput { pluginId: string; sourceId: string; dataType: string; limit: number; boundary?: RecordCursorBoundary }
