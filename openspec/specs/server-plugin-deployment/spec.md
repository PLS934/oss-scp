...
선택적 UI 산출물의 빌드·manifest·호환성·무결성 및 same-origin 파일 제공은 [UI 배포 계약](../plugin-ui-distribution/spec.md)을 따른다. 이 문서는 해당 검증을 전체 기동과 revision 단위 운영에 연결한다.
