...
GitHub Release의 개별 Docker 자산 사용법은 [릴리스 설치·업데이트 가이드](docs/release-installation.md)를, Registry 연결 없이 설치하는 단일 압축 번들의 선택·설치·업데이트·복구 절차는 [폐쇄망 번들 가이드](docs/offline-bundle.md)를 참고하세요.
